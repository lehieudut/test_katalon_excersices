...
WebUI.click(findTestObject('scenario5/Page_Home Page/a_My Cart11items'))

WebUI.click(findTestObject('scenario5/Page_Home Page/a_Remove'))

WebUI.click(findTestObject('scenario5/Page_Home Page/button_OK'))

WebUI.verifyElementText(findTestObject('scenario5/Page_Home Page/span_1'), '0')
